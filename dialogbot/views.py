...
class InteractionView(SlackMixin, View):
    ...
    def createJiraIssue(self):
        basejiraurl = "https://jira.godaddy.com"
        activeSprint = 'https://jira.godaddy.com/rest/agile/1.0/board/373/sprint?state=active'
        jsonStr = '{"fields": {"customfield_10007" : 19244, "project": {"key": "PKI"},"summary": "Test","issuetype": {"id": 8},"labels": ["Interruption","PKIDev"],"description": "This is an interruption. Auto-generated by PKIBot", "reporter" : {"name" : "mmurray"}, "assignee" : {"name" : "mmurray"}}}'
        issueJson = '{"fields": {"customfield_10007" : {currentSprint}, "project": {"key": "PKI"},"summary": {summary},"issuetype": {"id": 8},"labels": {labels},"description": {description}, "reporter" : {"name" : {username}}, "assignee" : {"name" : {username}}}}'
