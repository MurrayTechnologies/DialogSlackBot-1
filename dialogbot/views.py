...
class InteractionView(SlackMixin, View):
    ...
    def createJiraIssue(self):
        ...
        issueJson = '{"fields": {"customfield_10007" : {sprint}, "project": {"key": "PKI"},"summary": {summary},"issuetype": {"id": 8},"labels": {labels},"description": {description}, "reporter" : {"name" : {username}}, "assignee" : {"name" : {username}}}}'
